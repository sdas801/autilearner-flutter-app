...
class LearnEmotion extends StatefulWidget {
  const LearnEmotion({super.key});

  @override
  State<LearnEmotion> createState() => _LearnEmotionState();
}

class _LearnEmotionState extends State<LearnEmotion> {
  ...
  Widget build(BuildContext context) {
    return index == 14
        ...
        : Scaffold(
          appBar: AppBar(title: Text('Emotion Lesson')),
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  child: Image.asset(
                    'assets/images_emotion/${questionShape}.png',
...
List<_Question> _questionList = [
  for (int i = 0; i < 14; i++) _Question(questionShape: _items[i]),
];
